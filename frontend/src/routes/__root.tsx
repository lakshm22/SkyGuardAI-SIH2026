...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SkyGuard AI" },
      { name: "description", content: "AI-powered anomaly detection for automatic weather stations." },
      { property: "og:title", content: "SkyGuard AI" },
      { property: "og:description", content: "AI-powered anomaly detection for automatic weather stations." },
